...
public class StringUtil {
	...
	// 电话号码过滤特殊字符
	public static String toNum(String telephone_origin) {
		String telephone = telephone_origin;
		if(telephone_origin.contains("+86")){
			telephone = telephone_origin.replace("+86","");
		}
		String regEx="[^0-9]";
	...
	public static  boolean checkPwd(String pwd) {
		return isMatcherFinded("^(?![^a-zA-Z]+$)(?!\\D+$).{6,16}$", pwd);
	}
