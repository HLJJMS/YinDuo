...
public class RomUtils {
    ...
    public static void commonROMPermissionApplyInternal(Activity activity, int requestCode) throws NoSuchFieldException, IllegalAccessException {
        Class clazz = Settings.class;
        Field field = clazz.getDeclaredField("ACTION_MANAGE_OVERLAY_PERMISSION");
    ...
    public static void getAppDetailSettingIntent(Activity activity, int requestCode) {
        ...
        if (appIntent != null) {
            activity.startActivityForResult(appIntent, requestCode);
            return;
        }
