 ...
 */
@ActivityScope
class ShopConfirmReceivingGoodsModel
@Inject
constructor(repositoryManager: IRepositoryManager) : BaseModel(repositoryManager), ShopConfirmReceivingGoodsContract.Model {
    @Inject
