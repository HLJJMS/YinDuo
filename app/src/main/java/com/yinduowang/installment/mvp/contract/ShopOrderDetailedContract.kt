 ...
 * ================================================
 */
interface ShopOrderDetailedContract {
    //对于经常使用的关于UI的方法可以定义到IView中,如显示隐藏进度条,和显示文字消息
    interface View : IView{
     fun returnOrederDetailed(shopOrderDetailedEntity: ShopOrderDetailedEntity)
        fun refreshPageInfo()
        fun comnfirmAccept()
    }
    ...
    interface Model : IModel{
        ...
        fun orderRetreat(o_id: String): Observable<BasePhpResponse<Any>>
    }
