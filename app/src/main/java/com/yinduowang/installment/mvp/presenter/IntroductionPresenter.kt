...
@Inject
constructor(model: IntroductionContract.Model, rootView: IntroductionContract.View) :
        BasePresenter<IntroductionContract.Model, IntroductionContract.View>(model, rootView) {
    @Inject
