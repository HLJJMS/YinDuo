...
interface BillListContract {
    ...
    interface View : IView {
        fun getListSuccess( bean:BillListEntity)
        fun getListFail()
    }

    //Model层定义接口,外部只需关心Model返回的数据,无需关心内部细节,即是否使用缓存
    interface Model : IModel {
        fun getBillList(token: String, sign: String, id: String, year: String, month: String,type:String): Observable<BaseResponse<BillListEntity>>
    }
