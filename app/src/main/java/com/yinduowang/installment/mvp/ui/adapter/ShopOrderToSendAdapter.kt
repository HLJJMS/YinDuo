 ...
 * @Deprecated: false
 */
class ShopOrderToSendAdapter(data: List<ShopOrder>) : BaseQuickAdapter<ShopOrder, BaseViewHolder>(R.layout.item_shop_to_delivery_order, data) {
