 ...
 */
@ActivityScope
@Component(modules = arrayOf(CashLoanDetailedModule::class), dependencies = arrayOf(AppComponent::class))
interface CashLoanDetailedComponent {
    fun inject(activity: CashLoanDetailedActivity)
}
